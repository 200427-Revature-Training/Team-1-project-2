 ...
 * ######################################################
 */
INSERT INTO events.users (first_name,last_name,email,username,"password",picture_url,bio,role_id,band_id,favorite_song_id,place_id) VALUES 
('Ken','Renelt','ken@gmail.com','kRenelt','password','https://avatars2.githubusercontent.com/u/43582922?s=120&v=4','My name is Ken.',3,3,3,NULL)
,('Ryan','Clayton','ryan@gmail.com','Rclayton999','password','https://avatars2.githubusercontent.com/u/64425715?s=120&v=4','My name is Ryan.',4,NULL,4,NULL)
,('Milton','Reyes','Milton@gmail.com','milton-reyes','password','https://avatars3.githubusercontent.com/u/64162564?s=120&v=4','Mi nombre es Milton.',3,1,3,NULL)
,('Jordon','Hill','Hallstead2@gmail.com','Hallstead','password','https://avatars2.githubusercontent.com/u/38665384?s=460&v=4','I like hotdogs.',1,NULL,1,1)
,('Jackson','Hopkins','Jackson@gmail.com','mechawing','password','https://avatars2.githubusercontent.com/u/60560661?s=60&v=4','My name is Jackson.',2,1,2,NULL)
;
...
INSERT INTO events.bands ("name",picture_url,genre_id,featured_song_id,genre,favorite_song_id) VALUES 
('Dinnerware','https://images.crateandbarrel.com/is/image/Crate/BreeTeapotSHF15/?$web_product_hero$&190411134841&wid=625&hei=625',9,2,NULL,NULL)
,('Backstreet Boys','https://backstreetboys.com/cdn-cgi/image/width=600,quality=75/https://static.wonderfulunion.net/groundctrl/clients/backstreetboys/media/03/11/images/assets/original.xM4tlqOUONL6xs_cS38uy1YTXjy7LAPuv0Fig03ZeNE.png',10,3,NULL,NULL)
,('Nsync','https://s1.r29static.com/bin/entry/17f/x,80/1946653/image.jpg',10,4,NULL,NULL)
;
